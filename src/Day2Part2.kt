    ...
    for (word1 in wordsArray) {
        for (word2 in wordsArray) {
            if (word1 == word2) {
                ...
                var counter = 0
                val length = word1Array.size
                var result = ""

                for ((index, value) in word1Array.withIndex()) {
                    if (value == word2Array[index]) {
                        counter++
                        result += value
                    }
                }
